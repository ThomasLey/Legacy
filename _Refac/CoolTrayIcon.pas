...
begin
  if Assigned(PopupMenu) then
    if PopupMenu.AutoPopup then
      ...
      begin
        { Win98 seems to empty a popup menu before closing it.
          This is a problem when the menu is about to display while
          it already is active (two click-events following each
          other). Calling ProcessMessages fixes this. However, it
          seems to have some side effects. I'll look into it. }
...
procedure Register;
begin
  RegisterComponents('Neue', [TCoolTrayIcon]);
end;
