...
type
  TForm1 = class(TForm)
    ...
    procedure Winsock1Error(Sender: TObject);
    procedure Button2Click(Sender: TObject);
    procedure FormResize(Sender: TObject);
    procedure Timer1Timer(Sender: TObject);
    procedure WinSock1DataAvailable(Sender: TObject; Error: Word);
  private
    Counter: String;
...
procedure TForm1.Winsock1Error(Sender: TObject);
begin
      Form1.Caption := 'Fehler ist aufgetreten: ' ;
      try
         WinSock1.Close;
      finally
...
procedure TForm1.WinSock1DataAvailable(Sender: TObject; Error: Word);
begin
     Form1.Caption := WinSock1.ReceiveStr;
end;
